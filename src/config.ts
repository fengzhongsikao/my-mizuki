...
export const siteConfig: SiteConfig = {
	...
	bangumi: {
		userId: "1129280784", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
		fetchOnDev: true, // 是否在开发环境下获取 Bangumi 数据（默认 false），获取前先执行 pnpm build 构建 json 文件
	},

	bilibili: {
		vmid: "693214009", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	banner: {
		...
		src: {
			desktop: [
				"/assets/desktop-banner/wu1.jpeg",
				"/assets/desktop-banner/wu2.jpeg",
				"/assets/desktop-banner/wu3.jpeg",
			], // 桌面横幅图片
			mobile: [
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/xiao.png", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "风起",
	bio: "你未看此花时，此花与汝心同归于寂：你来看此花时，则此花颜色一时明白起来：便知此花不在你的心外。",
	typewriter: {
...
export const musicPlayerConfig: MusicPlayerConfig = {
	...
	meting_api: "https://meting.mikus.ink/api?server=:server&type=:type&id=:id", // Meting API 地址
	id: "2155423467", // 歌单ID
